...
\DeclarePanel{bottom}{
  \begin{picture}(0,0)
    \put(0,15){\parbox[c]{.98\pdfpagewidth}{\tiny\thedate\hfill\theslide/29}}
  \end{picture}
}
...
\begin{slide}
  ...
  \heading{Motivation}
  \begin{center}
    \resizebox*{.4\textwidth}{!}{\includegraphics{logo}}\bigskip\\
...
\begin{slide}
    \pdfbookmark[1]{Uniform Matrices}{uniform-matrices}
