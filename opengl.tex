...
\DeclarePanel{bottom}{
  \begin{picture}(0,0)
    \put(0,15){\parbox[c]{.98\pdfpagewidth}{\tiny\thedate\hfill\theslide/52}}
  \end{picture}
}
...
\begin{slide}
    ...
    \begin{center}
        \begin{minipage}[c]{.85\textwidth}
            \begin{minted}[highlightlines={3,5,9-12}]{glsl}
#version 410 core
uniform sampler2D tex;
uniform vec3 light;
in vec2 UV;
...
\begin{slide}
  ...
  \heading{Questions?}
  \begin{center}
    \animategraphics[width=.8\textwidth,loop,autoplay]{5}{final}{1}{18}
  \end{center}
\end{slide}
